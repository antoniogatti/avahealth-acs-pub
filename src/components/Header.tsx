...
import { Separator, Pivot, PivotItem, Stack, Image, ImageFit } from '@fluentui/react';
...
import logoSVG from '../assets/bluelogo.svg';
...
export default (props: HeaderProps): JSX.Element => {
    ...
    return (
        <Stack style={{ flex: '1' }} id="header" className={props.screenWidth > Constants.MINI_HEADER_WINDOW_WIDTH ? headerContainer : headerCenteredContainer}>
            <div style={{ display: 'flex', flex:'1' }}>
                <img style={{ width: '180px', paddingLeft:'20px' }} src={logoSVG.toString()} alt="logo" />
            </div>
            <Pivot
                onKeyDownCapture={(e) => {
