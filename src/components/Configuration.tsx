...
export default (props: ConfigurationScreenProps): JSX.Element => {
  ...
  const buttonText = 'Start call';
    ...
    const [name, setName] = useState(getUserNameFromUrl());
  ...
  return (
      <Stack className={mainContainerStyle} horizontalAlign="center" verticalAlign="center">
          <div style={{ width: '100%', position: 'relative', textAlign: 'center', marginTop:'70px' }}>
              <img style={{ width: '300px' }} src={logoPNG} alt="logo" />
          </div>
      {props.deviceManager ? (
          <Stack
          style={{ flex: '0 0 calc(50% - 16px)' }}
